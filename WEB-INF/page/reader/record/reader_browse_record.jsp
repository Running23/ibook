...
<section id="main-content">
    <section style="background-image: url(ibooks/img/5.jpg);">

        <p style="float: left;padding: 70px 0 0 10px;font-size: 15px;"><b>首页 >>会员管理 >>浏览记录</b></p>
        ...
        <div class="search-box" style="text-align: center;padding-top: 20px;font-size: 14px;padding-right: 10px;">
            ...
            <form>
            	日期范围: 
                <input type="date" name="mydate" id="mydate" style="height: 26px;line-height:.5em"/>
