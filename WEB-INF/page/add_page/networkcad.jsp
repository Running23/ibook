...
<head>
		...
		<!--css和js脚本写在外面  -->
		<link rel="stylesheet" href="<%=basePath%>/style/ibooks/css/addpage_css/networkcad.css" />
		<script src="<%=basePath%>/style/ibooks/js/addpage_js/networkcad.js"></script>
	...
	*********************************************************************************************************************************************************** -->
	...
	<nav style="height: 50px;width: 100%;" class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
	    <div class="container-fluid" >
	        <!--向左对齐-->
			<b class="navbar-text navbar-left glyphicon "><a href="${pageContext.request.contextPath}/l_system/librarian/view">首页</a>>>借还系统后台>>用户网证审核</b>
	        <!--向右对齐-->
	...
	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
		<div class="row">
			<p class="text_one"><img src="/ibook/style/indexassets/image/藏馆图书查询.png" class="img_one">用户网证审核</p>
		</div>
		...
		<div class="row">
			<div class="col-xs-12 col-sm-11 col-md-11 col-lg-11 space">
				<table border="0" class="table" style="table-layout: fixed;margin:0 auto;">
					...
					<thead>
					<tr>
						<td class="over">注册用户</td>
						<td class="over">性别</td>
						<td class="over">手机号</td>
						<td class="over">网证</td>
						<td class="over">状态</td>
						<td class="over">操作</td>
					</tr>
					...
					<tr>
						...
						<td class="over"></td>
						<td class="over"></td>
						<td class="over"><img src="/ibook/style/ibooks/img/3change.jpg" class="img-responsive pimg" id="pimg" width="100" height="100" style="margin:0 auto">
						<p>点击图片可以放大</p>
						</td>
						<td><a href="#">通过</a>/<a href="#">审核</a></td>
						<td><a href="#">修改</a>/<a href="#">删除</a>/<a href="#">通过</a></td>
					</tr>
					<tr>
						<td class="over"></td>
						<td class="over"></td>
