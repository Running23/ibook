...
<head>
		...
		<!--css和js脚本写在外面  -->
		<link rel="stylesheet" href="<%=basePath%>/style/ibooks/css/addpage_css/recommendput.css" />
		<script src="<%=basePath%>/style/ibooks/js/addpage_js/recommendput.js"></script>
	...
	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
		...
		<div class="row space_one">
			<div class="col-xs-4 col-xs-push-5 col-sm-4 col-md-4 col-md-push-6 col-lg-4">
				<input type="search" class="form-control" id="search" placeholder="设备号" autofocus>
			</div>
		...
		<div class="row">
			<div class="col-xs-12 col-sm-11 col-md-11 col-lg-11 space">
				<table border="0" class="table" style="table-layout: fixed;margin:0 auto;">
					...
					<thead>
					<tr>
						<td class="over">设备号</td>
						<td class="over">书籍名</td>
						<td class="over">地点</td>
						<td class="over">原因</td>
						<td class="over">状态</td>
						<td class="over">操作</td>
